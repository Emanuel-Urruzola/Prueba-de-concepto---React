...
function Footer () {
  return (
    <footer>
      ...
      <p>Grupo 2 </p>
      <a href='https://www.fing.edu.uy/tecnoinf/mvd/index.html' target='_blank' rel='noopener noreferrer'>Tecnólogo en informática</a>
      <div className='repository'>
        ...
        <a href='https://github.com/Emanuel-Urruzola/Prueba-de-concepto---React' target='_blank' rel='noopener noreferrer'>Repositorio</a>
      </div>
    </footer>
  )
}
